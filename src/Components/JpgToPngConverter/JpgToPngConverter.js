                ...
                <Col md={10} lg={8}>
                    <Card className="p-4 shadow bg-light text-dark">
                        <Card.Title className="text-center mb-4 card-title">
                            <FaImage /> <strong>JPG to PNG Converter</strong>
                        </Card.Title>
                        <Form>
                            <Form.Group>
                                <Form.Label>Upload JPG File</Form.Label>
                            ...
                            >
                                {loading ? <Spinner animation="border" size="sm" /> : <FaUpload />} Convert to PNG
                            </Button>
                        </Form>
